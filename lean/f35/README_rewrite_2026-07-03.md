...
exponential decay. Fix 3: `ρ(x) ∝ exp(−2(x−1)²/σ²)` centered at **r=1** with
coefficient **2** (from drift −2(r−1); the −4 is V's Lyapunov rate, not the
drift), not an `N(0,σ²)` centered at 0. Fix 2:
